<!DOCTYPE html>
<html lang="en">
<title>Nuestros Casos - Defensa Penal Norte</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <h1 class="page-heading">NUESTROS CASOS</h1>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="breadCrumb"><a href="index.php">Home</a> / <span>Nuestros Casos</span></div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row"> 
      ...
      <div class="col-md-6 col-sm-6">
        <div class="service-thumb">
          <div class="thumb-img"><img src="images/casos/CarabinerosWEB (3) (1).jpg" class="animate" alt=""></div>
          <h4>Detención ilegal por tráfico de droga y tenencia de armas</h4> 
          ...
          <a href="causa-rit-57-2017.php" class="btn">Leer más</a> 
        </div>
      </div>
